...
return array(
    ...
    '10' => array('name' => '数据库', 'icon' => 'xe621', 'sub' => array(
        ...
        '121' => array("show"=>1,"name" => '会员参数', 'controller' => 'system',			'action' => 'configuser'),
        '122' => array("show"=>1,"name" => '短信发送配置', 'controller' => 'system',			'action' => 'configsms'),
        '123' => array("show"=>1,"name" => 'APP弹窗配置', 'controller' => 'system',			'action' => 'configapppopupwindow'),
        '124' => array("show"=>1,"name" => '任务中心配置', 'controller' => 'system',			'action' => 'configtaskarticle'),
        '125' => array("show"=>1,"name" => 'APP版本管理', 'controller' => 'appversion',			'action' => 'index'),
        '126' => array("show"=>1,"name" => 'APP启动图片配置', 'controller' => 'appsetting',			'action' => 'index'),
		
		        '127' => array("show"=>1,'name' => '广告类型管理', 'controller' => 'adtype',		'action' => 'index'),
